...
export function AuthSplitPanel({ children }: AuthSplitPanelProps) {
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[55%] bg-forest relative overflow-hidden flex-col justify-between p-16">
        {/* Top label */}
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
            <span className="material-symbols-outlined text-forest">eco</span>
          </div>
      ...
      {/* Right panel — cream */}
      <div className="w-full lg:w-[45%] bg-surface flex items-center justify-center p-8 lg:p-12">
